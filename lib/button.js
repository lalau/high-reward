...
Button.prototype._renderBorder = function() {
    ...
    graphicUtil.drawRectBorder(this, 0, 0, config.width - 1, config.height - 1);
    graphicUtil.drawRectBorder(this, 1, 1, config.width - 3, config.height - 3);
    this.lineStyle(1, 0xAA5500, 1);
    graphicUtil.drawRectBorder(this, 0, 1, config.width - 2, config.height - 2);
