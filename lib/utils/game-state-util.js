...
gameStateUtil.getNewState = function() {
    return {
        ...
        regions: gameStateUtil._getRegions(),
...
gameStateUtil.rehydrate = function(driedState) {
    return {
        ...
        regions: driedState.regions || gameStateUtil._getRegions(),
...
gameStateUtil._getRegions = function() {
    return {
        zelerd: {
            pois: _.indexBy(_.map(Region.Pois.zelerd, function(poi) {
                return _.pick(poi, ['key', 'attributes'])
            }), 'key')
        }
    };
};
