...
TroopMenu.prototype.create = function() {
    ...
    selectMenu.onClick('info', function() {
        game.state.start(STATES.TroopInfo, undefined, undefined, commanderKey);
    });

    selectMenu.onClick('station', function() {
        game.state.start(STATES.StationMenu, undefined, undefined, troopPoint, commanderKey);
    });

    selectMenu.onClick('formation', function() {
        game.state.start(STATES.TroopFormation, undefined, undefined, commanderKey);
    });

    selectMenu.onClick('move', function() {
        game.state.start(STATES.RegionNavigation, undefined, undefined, troopPoint, commanderKey);
    });
