...
TroopFormationScreen.prototype._initPanelEvents = function() {
    ...
    panels.setup.events.onSubSlotSelect.add(this._handleSubSlotSelect, this);
};
...
TroopFormationScreen.prototype._handleSubSlotSelect = function(type) {
    var panels = this._panels;

    panels.formation.updateSubSlot(type);
};
