...
StoreScreen.prototype._initTroopInput = function() {
    ...
    storeTroopPanel.events.onUnitSlotOver.add(function(unitSlot) {
        ...
        if (this._selectedOffer) {
            ...
            if (sellPrice) {
                storeInfoPanel.setText('sell-info', {sell: sellPrice, sellName: sellCurrent.name});
            }
        }
    }, this);
    ...
    storeTroopPanel.events.onUnitSlotDown.add(function(memberIndex) {
