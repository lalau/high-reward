...
SelectMenu.prototype._renderTitle = function() {
    ...
    textUtil.renderText(this.game, width / 2, 5, title, { scale: 1.5, align: 'center', fill: SelectMenu.TITLE_FILL, parent: this });
};

SelectMenu.prototype._renderOptions = function() {
    var width = this._config.width;
    var menuOptions = this._menu.options;
    var optionTextConfig = { scale: 1.5, align: 'center', fill: SelectMenu.OPTION_FILL, parent: this };
    var optionTexts = {};
    var optionY = SelectMenu.TOP_PADDING + (this._menu.title ? SelectMenu.TITLE_HEIGHT : 0);
