...
MemberRow.prototype.render = function(member, index) {
    this._member = member;
    this._index = index;
...
MemberRow.prototype._renderIcon = function() {
    var game = this.game;
...
MemberRow.prototype._renderAttributes = function() {
    var game = this.game;
