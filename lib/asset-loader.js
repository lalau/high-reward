...
AssetLoader.prototype.load = function() {
    ...
    game.load.image('blue-flag', root + 'icons/blue-flag.png');
    game.load.image('pointer', root + 'icons/pointer.png');

    for (index=1; index<=11; index++) {
        game.load.image('man-'+index+'-portrait', root + 'portraits/man-'+index+'.png');
    }
    for (index=1; index<=7; index++) {
        game.load.image('woman-'+index+'-portrait', root + 'portraits/woman-'+index+'.png');
    }
    for (index=1; index<=7; index++) {
        game.load.image('girl-'+index+'-portrait', root + 'portraits/girl-'+index+'.png');
    }
