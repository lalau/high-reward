...
Troop.prototype.addMember = function(unit, memberIndex, slotIndex) {
    ...
    if (typeof slotIndex === 'number' && slotIndex < formation.length && typeof formation[slotIndex] !== 'number' && formation[slotIndex] !== 'L') {
        formation[slotIndex] = memberIndex;
    } else {
        formation.some(function(occupiedMemberIndex, index) {
            if (typeof occupiedMemberIndex !== 'number' && occupiedMemberIndex !== 'L') {
