...
function Panel(game, x, y, width, height, config) {
    if (x === 'center') {
...
Panel.prototype._renderBackground = function() {
    ...
    if (config.meshBg) {
        this.addChild(new Phaser.TileSprite(this.game, 3, 3, width - 6, height - 5, 'sprites', 'panel-bg-mesh.png'));
    } else {
