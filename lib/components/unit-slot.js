...
UnitSlot.prototype.enableSubSlot = function(type) {
    ...
    frameName = (frameName || 'empty-item-slot') + '.png';
    ...
    if (!this._subSlot) {
        this._subSlot = this.addChild(new Phaser.Image(game, UnitSlot.SUBSLOT_X, UnitSlot.SUBSLOT_Y, 'icons', frameName));
    }
