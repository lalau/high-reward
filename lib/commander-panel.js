...
CommanderPanel.prototype._renderPortrait = function() {
    ...
    this._portrait = new Phaser.Image(game, Panel.X_PADDING + 1, 16, portraitKey);
    this.addChild(this._portrait);
};

CommanderPanel.prototype._renderPortraitBorder = function() {
    var game = this._config.game;
    var border = new Phaser.Graphics(game, Panel.X_PADDING, 15);
...
CommanderPanel.prototype._renderCommander = function() {
    ...
    this._commanderImage = new Phaser.Image(game, Panel.X_PADDING, 207, assetKey);
